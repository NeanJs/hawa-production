...
export const ServiceCard = ({ icon, title, description, img }) => {
  return (
    <div className="service-card text-dark flex flex-col items-center text-center justify-center bg-white backdrop-blur-lg min-w-fit w-[300px] h-[400px] gap-8  shadow-lg">
      <div className="content-top flex-[.4] w-full h-full relative flex items-center justify-center bg-cover bg-dark">
        <Image src={img} className="absolute object-cover top-0 left-0 w-full h-full opacity-40"/>
